...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            (getOwner() == msg.sender) ||
                isApprovedForAll(msg.sender, ownerOf(tokenId)),
...
contract NhutNguyenGroupToken is ERC721Metadata{
    string private _name = "NhutNguyenGroupToken";
    string private _symbol = "NNG";
